...
var questions = [{
	...
	question: {
		title: "The robot from Futurama is named",
		answers: ["R2D2","Bender","Data","XYZ"]
	},
	answer: 1
}];
...
var game = function(a,b){
	...
	var end = function(){
		...
		user.updateStats(player1.user._id, questions.length, player1.correct, player1.score, state, function(err, collection){

		});

		user.updateStats(player2.user._id, questions.length, player2.correct, player2.score, -state, function(err, collection){
